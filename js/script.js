    ...
    switch (seccion) {
        ...
        case 'cursos':
            case 'cursos':
                ...
                contenido += '<img src="images/auxiliaradministrativo.jpg" class="card-img-top" alt="Curso 1">';
                ...
                contenido += '</div>';
                contenido += '<div class="card">';
                contenido += '<img src="imagen_2" class="card-img-top" alt="Curso 2">';
                contenido += '<div class="card-body">';
                ...
                contenido += '</div>';
                contenido += '<div class="card">';
                contenido += '<img src="imagen_3" class="card-img-top" alt="Curso 3">';
                contenido += '<div class="card-body">';
